...
import { uploadStagePhoto } from '../lib/data.js';
...
export default function FieldCaptureView({ posts, stageDefs, onUpdatePost, userProfile, canCaptureStage, incidents, onCreateIncident, onRequestCreatePost, initialPostId, initialStageId, onClearTarget }) {
...
function InlineStageCaptureForm({ post, stage, onSave, onBack, incidents, onCreateIncident, userProfile }) {
  ...
  const existingPhotos = existing.photo && typeof existing.photo === 'string' ? [existing.photo]
